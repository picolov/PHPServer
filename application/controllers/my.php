...
//		$loggingCommentLines = explode("\n", wordwrap($loggingComment, 103));
		...
		$controls = array(
				...
				'activation_1' => key_exists('activation_1', $onSiteTechData) ? $this->wrapText(128, $onSiteTechData['activation_1'], 8) : '',
				'activation_2' => key_exists('activation_2', $onSiteTechData) ? $this->wrapText(128, $onSiteTechData['activation_2'], 8) : '',
				'activation_3' => key_exists('activation_3', $onSiteTechData) ? $this->wrapText(128, $onSiteTechData['activation_3'], 8) : '',
				'activation_4' => key_exists('activation_4', $onSiteTechData) ? $this->wrapText(128, $onSiteTechData['activation_4'], 8) : '',
				'activation_5' => key_exists('activation_5', $onSiteTechData) ? $this->wrapText(128, $onSiteTechData['activation_5'], 8) : '',
				'activation_6' => key_exists('activation_6', $onSiteTechData) ? $this->wrapText(128, $onSiteTechData['activation_6'], 8) : '',

				'toolsfreed_1' => key_exists('toolsfreed_1', $onSiteTechData) ? $this->wrapText(115, $onSiteTechData['toolsfreed_1'], 8) : '',
				'toolsfreed_2' => key_exists('toolsfreed_2', $onSiteTechData) ? $this->wrapText(115, $onSiteTechData['toolsfreed_2'], 8) : '',
				'toolsfreed_3' => key_exists('toolsfreed_3', $onSiteTechData) ? $this->wrapText(115, $onSiteTechData['toolsfreed_3'], 8) : '',
				'toolsfreed_4' => key_exists('toolsfreed_4', $onSiteTechData) ? $this->wrapText(115, $onSiteTechData['toolsfreed_4'], 8) : '',
				'toolsfreed_5' => key_exists('toolsfreed_5', $onSiteTechData) ? $this->wrapText(115, $onSiteTechData['toolsfreed_5'], 8) : '',
				'toolsfreed_6' => key_exists('toolsfreed_6', $onSiteTechData) ? $this->wrapText(115, $onSiteTechData['toolsfreed_6'], 8) : '',

				'fishing_1' => key_exists('fishing_1', $onSiteTechData) ? $this->wrapText(134, $onSiteTechData['fishing_1'], 8) : '',
				'fishing_2' => key_exists('fishing_2', $onSiteTechData) ? $this->wrapText(134, $onSiteTechData['fishing_2'], 8) : '',
				'fishing_3' => key_exists('fishing_3', $onSiteTechData) ? $this->wrapText(134, $onSiteTechData['fishing_3'], 8) : '',
				'fishing_4' => key_exists('fishing_4', $onSiteTechData) ? $this->wrapText(134, $onSiteTechData['fishing_4'], 8) : '',
				'fishing_5' => key_exists('fishing_5', $onSiteTechData) ? $this->wrapText(134, $onSiteTechData['fishing_5'], 8) : '',
				'fishing_6' => key_exists('fishing_6', $onSiteTechData) ? $this->wrapText(134, $onSiteTechData['fishing_6'], 8) : '',
