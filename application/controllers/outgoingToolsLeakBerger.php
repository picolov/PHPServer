...
class OutgoingToolsLeakBerger extends BaseController {
	
	public function __construct()
    {
    	$this->setDoc('OutgoingToolsLeakBerger');
    ...
    /**
     * Get all List of leak berger with Job detail
    ...
    /**
     * Get Last Created leak berger by Job id
     * @return multitype:unknown
     */
