...
class OutgoingToolsLeakBurton extends BaseController {
	
	public function __construct()
    {
    	$this->setDoc('OutgoingToolsLeakBurton');
    ...
    /**
     * Get Last Created leak burton by Job id
     * @return multitype:unknown
     */
