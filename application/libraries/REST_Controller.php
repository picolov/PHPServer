...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
    ...
    /**
     * Output template for all Rest service created
     */
    protected $tokenKey = [];
    ...
    public function __construct($config = 'rest')
    {
    	...
    	header("Access-Control-Allow-Headers: X-API-KEY, X-TOKEN-KEY, Origin, X-Requested-With, Content-Type, Accept, Access-Control-Request-Method");
